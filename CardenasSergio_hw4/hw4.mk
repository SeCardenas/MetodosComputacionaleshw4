...
mean_fixed_boundaries.txt mean_open_boundaries.txt mean_periodic_boundaries.txt temp_fixed_boundaries.txt temp_open_boundaries.txt temp_periodic_boundaries.txt: PDE.cpp
	g++ PDE.cpp
	./a.out
	rm ./a.out
