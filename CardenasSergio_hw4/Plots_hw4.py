...
ax.set_ylabel('$y$')
ax.set_zlabel('$T$')
ax.set_title('Temperatura fronteras fijas t={}'.format(mean_fixed[125,0]))
fig.colorbar(surf, shrink=0.5, aspect=5)
...
ax.set_ylabel('$y$')
ax.set_zlabel('$T$')
ax.set_title('Temperatura fronteras fijas t={}'.format(mean_fixed[250,0]))
fig.colorbar(surf, shrink=0.5, aspect=5)
...
ax.set_ylabel('$y$')
ax.set_zlabel('$T$')
ax.set_title('Temperatura fronteras fijas t={}'.format(mean_fixed[-1,0]))
fig.colorbar(surf, shrink=0.5, aspect=5)
...
ax.set_ylabel('$y$')
ax.set_zlabel('$T$')
ax.set_title('Temperatura fronteras periodicas t={}'.format(mean_periodic[1000,0]))
fig.colorbar(surf, shrink=0.5, aspect=5)
...
ax.set_ylabel('$y$')
ax.set_zlabel('$T$')
ax.set_title('Temperatura fronteras periodicas t={}'.format(mean_periodic[2000,0]))
fig.colorbar(surf, shrink=0.5, aspect=5)
...
ax.set_ylabel('$y$')
ax.set_zlabel('$T$')
ax.set_title('Temperatura fronteras periodicas t={}'.format(mean_periodic[-1,0]))
fig.colorbar(surf, shrink=0.5, aspect=5)
...
ax.set_ylabel('$y$')
ax.set_zlabel('$T$')
ax.set_title('Temperatura fronteras abiertas t={}'.format(mean_open[1000,0]))
fig.colorbar(surf, shrink=0.5, aspect=5)
...
ax.set_ylabel('$y$')
ax.set_zlabel('$T$')
ax.set_title('Temperatura fronteras abiertas t={}'.format(mean_open[2000,0]))
fig.colorbar(surf, shrink=0.5, aspect=5)
...
ax.set_ylabel('$y$')
ax.set_zlabel('$T$')
ax.set_title('Temperatura fronteras abiertas t={}'.format(mean_open[-1,0]))
fig.colorbar(surf, shrink=0.5, aspect=5)
