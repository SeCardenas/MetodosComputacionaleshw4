...
\begin{figure}[H]
    \centering
    \subfigure[]{\label{PDE1_1}\includegraphics[scale = 0.5]{temp_fixed_1.png}}
    \subfigure[]{\label{PDE1_2}\includegraphics[scale = 0.5]{temp_fixed_2.png}}
    \label{fig:my_label}
\end{figure}
\begin{figure}[H]
    \centering
    \subfigure[]{\label{fig:PDE1_3}\includegraphics[scale = 0.4]{temp_fixed_3.png}}
    \subfigure[]{\label{fig:PDE1_4}\includegraphics[scale = 0.4]{temp_fixed_4.png}}
